...
export const Bio: BioType = {
  ...
  shortName: "SIVAMUTHU",
  roles: ["Full Stack Developer", "AI Engineer", "Backend Architect", "React Specialist"],
...
export const projects: Project[] = [
  {
    ...
    tags: ["React", "NestJS", "MongoDB", "Kafka", "Redis", "Elasticsearch", "Tesseract OCR", "Document AI"],
    category: "web app",
    github: "https://github.com/sivaganesz",
    webapp: "",
  },
